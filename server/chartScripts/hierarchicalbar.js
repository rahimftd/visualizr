...
<script>
  ...
  var m = [80, 160, 0, 160], // top right bottom left
      w = (parseInt(d3.select('#chart-container').style('width'), 10)) - m[1] - m[3], // width
      h = (parseInt(d3.select('#chart-container').style('width'), 10)) - m[0] - m[2], // height
  ...
  var svg = d3.select("#chart-container").append("svg:svg")
